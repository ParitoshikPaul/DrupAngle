 ...
 * About Drupal Angular Distribution
...
Drupal Angular is a distribution to cater the need of working seemless with angular supporting drupal as a backend and we have full command over sitebulding which reflects in angular as different components like forms, blocks, views and other entities in Drupal 8.
